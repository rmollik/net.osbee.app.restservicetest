...
public class ReportToolbar implements IToolbarAction {
  ...
  public void createToolbar(final IEclipseContext eclipseContext, final IPresentationEngine renderingEngine, final IThemeResourceService themeResourceService, final String uuid) {
    ...
    toolItem.setTooltip("printDownload");
    toolItem.setIconURI(themeResourceService.getThemeURI("download", ThemeResourceType.ICON));
    toolItem.setEnabled(true);
    toolItem.setToBeRendered(true);
    toolItem.setVisible(true);
    setCommand("printDownload", toolItem, application);
    toolbar.getChildren().add(toolItem);
    toolItem.getTags().add("ReportDownload");
    toolItem = factory.createHandledToolItem();
    toolItem.setElementId(UUID.randomUUID().toString());
    toolItem.setType(ItemType.PUSH);
    toolItem.setTooltip("print");
    toolItem.setIconURI(themeResourceService.getThemeURI("print", ThemeResourceType.ICON));
    toolItem.setEnabled(true);
    toolItem.setToBeRendered(true);
    toolItem.setVisible(true);
    setCommand("print", toolItem, application);
    toolbar.getChildren().add(toolItem);
    toolItem.getTags().add("PrintOnServer");
    }
  }

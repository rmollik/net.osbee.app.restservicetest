...
public class CancelItemAction {
  ...
  public void execute(final IEclipseContext eclipseContext, final IEventDispatcher eventDispatcher) {
    ...
    EventDispatcherEvent evnt = new EventDispatcherEvent(perspective, EventDispatcherCommand.ACTION, uuid, "net.osbee.app.restservicetest.model.actions.cancelItem");

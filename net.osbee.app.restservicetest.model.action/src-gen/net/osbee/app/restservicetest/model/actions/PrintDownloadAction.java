...
public class PrintDownloadAction {
  ...
  public void execute(final IEclipseContext eclipseContext, final IEventDispatcher eventDispatcher) {
    log.debug("action execute called for printDownload");
    String uuid = (String)eclipseContext.get("TOOLBAR_UUID");
    MPerspective perspective = eclipseContext.get(MPerspective.class);
    EventDispatcherEvent evnt = new EventDispatcherEvent(perspective, EventDispatcherCommand.ACTION, uuid, "net.osbee.app.restservicetest.model.actions.printDownload");
    evnt.addItem(EventDispatcherDataTag.BUTTON_ID, ReportActionEnum.REPORT_ACTION_DOWNLOAD_PDF);

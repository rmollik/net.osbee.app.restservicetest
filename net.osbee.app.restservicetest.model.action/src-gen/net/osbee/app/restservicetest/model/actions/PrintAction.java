...
public class PrintAction {
  ...
  public void execute(final IEclipseContext eclipseContext, final IEventDispatcher eventDispatcher) {
    ...
    EventDispatcherEvent evnt = new EventDispatcherEvent(perspective, EventDispatcherCommand.ACTION, uuid, "net.osbee.app.restservicetest.model.actions.print");
    evnt.addItem(EventDispatcherDataTag.BUTTON_ID, ReportActionEnum.REPORT_ACTION_PRINT_ON_SERVER_PDF);

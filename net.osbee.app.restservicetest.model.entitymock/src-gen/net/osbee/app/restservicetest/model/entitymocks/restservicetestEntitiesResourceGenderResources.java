...
public class restservicetestEntitiesResourceGenderResources extends ABaseMockResource {
  public restservicetestEntitiesResourceGenderResources() {
    setAttributes("flag","description");
    addDataRow("MALE","M","male");
    addDataRow("FEMALE","F","female");

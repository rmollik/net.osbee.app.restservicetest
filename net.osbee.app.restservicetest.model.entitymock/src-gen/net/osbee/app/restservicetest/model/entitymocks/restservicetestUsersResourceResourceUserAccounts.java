...
public class restservicetestUsersResourceResourceUserAccounts extends ABaseMockResource {
  public restservicetestUsersResourceResourceUserAccounts() {
    setAttributes("userName","password","email","position","enabled","localeTag","isSuperuser");
    addDataRow("ADMIN","Admin","Admin","admin@test.local","Admin","false","en-US","true");
